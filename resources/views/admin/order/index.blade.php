       ...
       <div class="row">
        <div class="col-lg-12">
            <div class="breadcrumb-main">
                <h4 class="text-capitalize breadcrumb-title">Order Management</h4>
                ...
                <div class="breadcrumb-main m-0 breadcrumb-main--table justify-content-sm-between ">
                    <div class=" d-flex flex-wrap justify-content-center breadcrumb-main__wrapper">
                        <div class="d-flex align-items-center ticket__title justify-content-center me-md-25 mb-md-0 mb-20">
                            <h4 class="text-capitalize fw-500 breadcrumb-title">Manage all orders</h4>
                        </div>
                    </div>
                        ...
                        <table class="table mb-0 table-borderless">
                            <thead>
                                <tr class="userDatatable-header">
                                    ...
                                    <th>
                                        <span class="userDatatable-title">user__name</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">order_number</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">total_amount</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">discount</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">shipping_cost</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">payment_status</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">order_status</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">shipping_address_name</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">payment_method</span>
                                    </th>
                                    <th class="actions">
