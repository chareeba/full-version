                        ...
                        <table class="table mb-0 table-borderless">
                            <thead>
                                <tr class="userDatatable-header">
                                    ...
                                    <th>
                                        <span class="userDatatable-title">discount_type</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">start_date</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">end_date</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">min_order_amount</span>
                                    </th>
                                    <th>
                                        <span class="userDatatable-title">max_uses</span>
                                    </th>
                                    <th>
