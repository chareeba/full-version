            ...
            <div class="hexadash-top-menu position-relative">
                <ul>
                    <li class="has-subMenu">
                        <a href="#"
                            class="{{ Request::is($locale . '/dashboards/*') ? 'active' : '' }}">Dashboard</a>
                        <ul class="subMenu">
                            <li><a class="{{ Request::is($locale . '/dashboards/demo-one') ? 'active' : '' }}"
                                    href="{{ route('dashboard.demo_one', $locale) }}">{{ trans('menu.dashboard-demo-one') }}</a>
                            </li>
                            <li><a class="{{ Request::is($locale . '/dashboards/demo-two') ? 'active' : '' }}"
                                    href="{{ route('dashboard.demo_two', $locale) }}">{{ trans('menu.dashboard-demo-two') }}</a>
                            </li>
                            <li><a class="{{ Request::is($locale . '/dashboards/demo-three') ? 'active' : '' }}" <li><a
                                        href="{{ route('table.basic', $locale) }}"
                                        class="{{ Request::is($locale . '/table/basic') ? 'active' : '' }}">{{ trans('menu.table-basic') }}</a>
                            </li>
                            <li><a href="{{ route('table.data', $locale) }}"
                                    class="{{ Request::is($locale . '/table/data') ? 'active' : '' }}">{{ trans('menu.table-data') }}</a>
                            </li>
                            <li><a href="{{ route('pages.dynamic_table', $locale) }}"
                                    class="{{ Request::is($locale . '/pages/dynamic-table') ? 'active' : '' }}">{{ trans('menu.dynamic-table-menu-title') }}</a>
                            </li>
                            href="{{ route('dashboard.demo_six', $locale) }}">{{ trans('menu.dashboard-demo-six') }}</a>
                    </li>
                    <li><a class="{{ Request::is($locale . '/dashboards/demo-seven') ? 'active' : '' }}"
                            href="{{ route('dashboard.demo_seven', $locale) }}">{{ trans('menu.dashboard-demo-seven') }}</a>
                    </li>
                    <li><a class="{{ Request::is($locale . '/dashboards/demo-eight') ? 'active' : '' }}"
                            href="{{ route('dashboard.demo_eight', $locale) }}">{{ trans('menu.dashboard-demo-eight') }}</a>
                    </li>
                    <li><a class="{{ Request::is($locale . '/dashboards/demo-nine') ? 'active' : '' }}"
                            href="{{ route('dashboard.demo_nine', $locale) }}">{{ trans('menu.dashboard-demo-nine') }}</a>
                    </li>
                    <li><a class="{{ Request::is($locale . '/dashboards/demo-ten') ? 'active' : '' }}"
                            href="{{ route('dashboard.demo_ten', $locale) }}">{{ trans('menu.dashboard-demo-ten') }}</a>
                    </li>
                </ul>
                </li>
                <li class="has-subMenu">
                ...
                <li class="has-subMenu">
                    <a href="#"
                        class="{{ Request::is($locale . '/table/*') || Request::is($locale . '/pages/dynamic-table') || Request::is($locale . '/applications/job/*') || Request::is($locale . '/applications/support/*') || Request::is($locale . '/applications/social/profile-settings') || Request::is($locale . '/applications/bookmark') || Request::is($locale . '/applications/task') || Request::is($locale . '/applications/filemanager') || Request::is($locale . '/applications/import_export/*') || Request::is($locale . '/applications/kanban') || Request::is($locale . '/applications/todo') || Request::is($locale . '/applications/note') || Request::is($locale . '/applications/contact/*') || Request::is($locale . '/applications/user/*') || Request::is($locale . '/applications/calendar') || Request::is($locale . '/applications/project/*') || Request::is($locale . '/applications/ecommerce/*') || Request::is($locale . '/applications/email/*') || Request::is($locale . '/applications/chat') ? 'active' : '' }}">Apps</a>
                    <ul class="megaMenu-wrapper megaMenu-dropdown">
                        <li>
                            <ul>
                                <li class="has-subMenu-left">
                                    <a href="#"
                                        class="{{ Request::is($locale . '/applications/email/*') ? 'active' : '' }}">
                                        <span class="nav-icon uil uil-envelope"></span>
                                        <span class="menu-text">{{ trans('menu.email-menu-title') }}</span>
                                    </a>
                                    <ul class="subMenu">
                                        <li><a class="{{ Request::is($locale . '/applications/email/inbox') ? 'active' : '' }}"
                                                href="{{ route('email.inbox', $locale) }}">{{ trans('menu.email-inbox') }}</a>
                                        </li>
                                        <li><a class="{{ Request::is($locale . '/applications/email/read') ? 'active' : '' }}"
                                                href="{{ route('email.read', $locale) }}">{{ trans('menu.email-read') }}</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{ route('chat', $locale) }}"
                                        class="{{ Request::is($locale . '/applications/chat') ? 'active' : '' }}">
                                ...
                                <li class="has-subMenu-left">
                                    <a href="#"
                                        class="{{ Request::is($locale . '/applications/ecommerce/*') ? 'active' : '' }}">
                                        <span class="nav-icon uil uil-bag"></span>
                                        <span
                                            class="menu-text text-initial">{{ trans('menu.ecommerce-menu-title') }}</span>
                                    </a>
                                    <ul class="subMenu">
                                        <li><a href="{{ route('ecommerce.products', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/ecommerce/products') ? 'active' : '' }}">{{ trans('menu.ecommerce-products') }}</a>
                                        </li>
                                        <li><a href="{{ route('ecommerce.product_detail', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/ecommerce/product-detail') ? 'active' : '' }}">{{ trans('menu.ecommerce-product-details') }}</a>
                                        </li>
                                        <li><a href="{{ route('ecommerce.add_product', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/ecommerce/add-product') ? 'active' : '' }}">{{ trans('menu.ecommerce-product-add') }}</a>
                                        </li>
                                        <li><a href="{{ route('ecommerce.cart', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/ecommerce/cart') ? 'active' : '' }}">{{ trans('menu.ecommerce-cart') }}</a>
                                        </li>
                                        <li><a href="{{ route('ecommerce.orders', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/ecommerce/orders') ? 'active' : '' }}">{{ trans('menu.ecommerce-orders') }}</a>
                                        </li>
                                        <li><a href="{{ route('ecommerce.sellers', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/ecommerce/sellers') ? 'active' : '' }}">{{ trans('menu.ecommerce-sellers') }}</a>
                                        </li>
                                        <li><a href="{{ route('ecommerce.invoice', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/ecommerce/invoice') ? 'active' : '' }}">{{ trans('menu.ecommerce-invoices') }}</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="has-subMenu-left">
                                    <a href="#"
                                        class="{{ Request::is($locale . '/applications/project/*') ? 'active' : '' }}">
                                        <span class="nav-icon uil uil-folder"></span>
                                        <span class="menu-text">{{ trans('menu.project-menu-title') }}</span>
                                    </a>
                                    <ul class="subMenu">
                                        <li><a href="{{ route('project.project_list', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/project/list') ? 'active' : '' }}">{{ trans('menu.project-title') }}</a>
                                        </li>
                                        <li><a href="{{ route('project.project_detail', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/project/project-detail') ? 'active' : '' }}">{{ trans('menu.project-detail') }}</a>
                                        </li>
                                        <li><a href="{{ route('project.create_project', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/project/create') ? 'active' : '' }}">{{ trans('menu.create-project') }}</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{ route('calendar', $locale) }}"
                                        class="{{ Request::is($locale . '/applications/calendar') ? 'active' : '' }}">
                                ...
                                <li class="has-subMenu-left">
                                    <a href="#"
                                        class="{{ Request::is($locale . '/applications/user/*') ? 'active' : '' }}">
                                        <span class="nav-icon uil uil-users-alt"></span>
                                        <span class="menu-text">{{ trans('menu.user-menu-title') }}</span>
                                    </a>
                                    <ul class="subMenu">
                                        <li><a href="{{ route('user.member', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/user/member') ? 'active' : '' }}">{{ trans('menu.user-team') }}</a>
                                        </li>
                                        <li><a href="{{ route('user.grid', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/user/grid') ? 'active' : '' }}">{{ trans('menu.user-grid') }}</a>
                                        </li>
                                        <li><a href="{{ route('user.list', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/user/list') ? 'active' : '' }}">{{ trans('menu.user-list') }}</a>
                                        </li>
                                        <li><a href="{{ route('user.grid_style', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/user/grid-style') ? 'active' : '' }}">{{ trans('menu.user-grid-style') }}</a>
                                        </li>
                                        <li><a href="{{ route('user.group', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/user/group') ? 'active' : '' }}">{{ trans('menu.user-group') }}</a>
                                        </li>
                                        <li><a href="{{ route('user.add', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/user/add') ? 'active' : '' }}">{{ trans('menu.user-add') }}</a>
                                        </li>
                                        <li><a href="{{ route('user.table', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/user/table') ? 'active' : '' }}">{{ trans('menu.user-table') }}</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="has-subMenu-left">
                                    <a href="#"
                                        class="{{ Request::is($locale . '/applications/contact/*') ? 'active' : '' }}">
                                        <span class="nav-icon uil uil-at"></span>
                                        <span class="menu-text">{{ trans('menu.contact-menu-title') }}</span>
                                    </a>
                                    <ul class="subMenu">
                                        <li><a class="{{ Request::is($locale . '/applications/contact/grid') ? 'active' : '' }}"
                                                href="{{ route('contact.grid', $locale) }}">{{ trans('menu.contact-grid') }}</a>
                                        </li>
                                        <li><a class="{{ Request::is($locale . '/applications/contact/list') ? 'active' : '' }}"
                                                href="{{ route('contact.list', $locale) }}">{{ trans('menu.contact-list') }}</a>
                                        </li>
                                        <li><a class="{{ Request::is($locale . '/applications/contact/create') ? 'active' : '' }}"
                                                href="{{ route('contact.create', $locale) }}">{{ trans('menu.contact-list') }}</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{ route('note', $locale) }}"
                                        class="{{ Request::is($locale . '/applications/note') ? 'active' : '' }}">
                                        <span class="nav-icon uil uil-clipboard-notes"></span>
                                        <span class="menu-text">{{ trans('menu.note-menu-title') }}</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('todo', $locale) }}"
                                        class="{{ Request::is($locale . '/applications/todo') ? 'active' : '' }}">
                        ...
                        <li>
                            <ul>
                                <li>
                                    <a href="{{ route('kanban', $locale) }}"
                                        class="{{ Request::is($locale . '/applications/kanban') ? 'active' : '' }}">
                                ...
                                <li class="has-subMenu-left">
                                    <a href="#"
                                        class="{{ Request::is($locale . '/applications/import_export/*') ? 'active' : '' }}">
                                        <span class="nav-icon uil uil-exchange"></span>
                                        <span class="menu-text">{{ trans('menu.ie-menu-title') }}</span>
                                    </a>
                                    <ul class="subMenu">
                                        <li><a class="{{ Request::is($locale . '/applications/import_export/import') ? 'active' : '' }}"
                                                href="{{ route('import_export.import', $locale) }}">{{ trans('menu.ie-import') }}</a>
                                        </li>
                                        <li><a class="{{ Request::is($locale . '/applications/import_export/export') ? 'active' : '' }}"
                                                href="{{ route('import_export.export', $locale) }}">{{ trans('menu.ie-export') }}</a>
                                        </li>
                                        <li><a class="{{ Request::is($locale . '/applications/import_export/export-selected') ? 'active' : '' }}"
                                                href="{{ route('import_export.export_selected', $locale) }}">{{ trans('menu.ie-export-selected') }}</a>
                                        </li>
                                    </ul>
                                </li>
                                <li>
                                    <a href="{{ route('filemanager', $locale) }}"
                                        class="{{ Request::is($locale . '/applications/filemanager') ? 'active' : '' }}">
                                        <span class="nav-icon uil uil-repeat"></span>
                                        <span class="menu-text">{{ trans('menu.filemanager-menu-title') }}</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('task', $locale) }}"
                                        class="{{ Request::is($locale . '/applications/task') ? 'active' : '' }}">
                                        <span class="nav-icon uil uil-lightbulb-alt"></span>
                                        <span class="menu-text">{{ trans('menu.task-menu-title') }}</span>
                                    </a>
                                </li>
                                <li>
                                    <a href="{{ route('bookmark', $locale) }}"
                                        class="{{ Request::is($locale . '/applications/bookmark') ? 'active' : '' }}">
                                ...
                                <li class="has-subMenu-left">
                                    <a href="#"
                                        class="{{ Request::is($locale . '/applications/social/*') ? 'active' : '' }}">
                                        <span class="nav-icon uil uil-apps"></span>
                                        <span class="menu-text">{{ trans('menu.social-menu-title') }}</span>
                                    </a>
                                    <ul class="subMenu">
                                        <li class="nav-item"><a href="{{ route('social.profile', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/social/profile') ? 'active' : '' }}">{{ trans('menu.social-profile') }}</a>
                                        </li>
                                        <li><a href="{{ route('social.profile_settings', $locale) }}"
                                                class="{{ Request::is($locale . '/applications/social/profile-settings') ? 'active' : '' }}">{{ trans('menu.social-profile-setting') }}</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="has-subMenu-left">
                                    <a href="#"
                                        class="{{ Request::is($locale . '/applications/support/*') ? 'active' : '' }}">
                                        <span class="nav-icon uil uil-user"></span>
                                        <span class="menu-text">{{ trans('menu.support-menu-title') }}</span>
                                    </a>
                                    <ul class="subMenu">
                                        <li><a class="{{ Request::is($locale . '/applications/support/support-ticket') ? 'active' : '' }}"
                                                href="{{ route('support.support_ticket', $locale) }}">{{ trans('menu.support-ticket') }}</a>
                                        </li>
                                        <li><a class="{{ Request::is($locale . '/applications/support/support-details') ? 'active' : '' }}"
                                                href="{{ route('support.support_detail', $locale) }}">{{ trans('menu.support-ticket-detail') }}</a>
                                        </li>
                                        <li><a class="{{ Request::is($locale . '/applications/support/new-ticket') ? 'active' : '' }}"
                                                href="{{ route('support.new_ticket', $locale) }}">{{ trans('menu.support-new-ticket') }}</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="has-subMenu-left">
                                    <a href="#"
                                        class="{{ Request::is($locale . '/applications/job/*') ? 'active' : '' }}">
                                        <span class="nav-icon uil uil-search"></span>
                                        <span class="menu-text">{{ trans('menu.job-menu-title') }}</span>
                                    </a>
                                    <ul class="subMenu">
                                        <li><a class="{{ Request::is($locale . '/applications/job/job-search') ? 'active' : '' }}"
                                                href="{{ route('job.job_search', $locale) }}">{{ trans('menu.job-search') }}</a>
                                        </li>
                                        <li><a class="{{ Request::is($locale . '/applications/job/job-search-list') ? 'active' : '' }}"
                                                href="{{ route('job.job_search_list', $locale) }}">{{ trans('menu.job-search-list') }}</a>
                                        </li>
                                        <li><a class="{{ Request::is($locale . '/applications/job/job-detail') ? 'active' : '' }}"
                                                href="{{ route('job.job_detail', $locale) }}">{{ trans('menu.job-detail') }}</a>
                                        </li>
                                        <li><a class="{{ Request::is($locale . '/applications/job/job-apply') ? 'active' : '' }}"
                                                href="{{ route('job.job_apply', $locale) }}">{{ trans('menu.job-apply') }}</a>
                                        </li>
                                    </ul>
                                </li>
                                <li class="has-subMenu-left">
                                    <a href="#"
                                        class="{{ Request::is($locale . '/table/*') || Request::is($locale . '/pages/dynamic-table') ? 'active' : '' }}">
                ...
                <li class="has-subMenu">
                    ...
                    <ul class="subMenu">
                        ...
                        <li class="has-subMenu-left">
                            <a href="#"
                                class="{{ Request::is(app()->getLocale() . '/map/*') ? 'active' : '' }}">
